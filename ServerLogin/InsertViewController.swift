...
class InsertViewController: UIViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func textFieldShouldReturn(_ textField: UITextField) -> Bool { // delegate 연결
        textField.resignFirstResponder() //return -> done변경
    ...
    @IBAction func saveFavorite(_ sender: UIBarButtonItem) {
        ...
        guard let myImage = imageView.image
            else {
        ...
        let myUrl = URL(string: "http://condi.swu.ac.kr/student/T09/favorite/upload.php");
        ...
        // 4/4
        let urlString: String = "http://condi.swu.ac.kr/student/T09/favorite/insertFavorite.php"
